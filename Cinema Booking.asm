...
seiners_film  DD 23 ; seniers Price for film theater

child_action    DD 5  ; child Price for action theater       
adult_action    DD 35 ; adult Price for action theater
seiners_action  DD 15 ; seniers Price for action theater
